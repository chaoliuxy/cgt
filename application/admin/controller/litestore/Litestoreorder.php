...
class Litestoreorder extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\litestore\Litestoreorder;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','order_no','total_price','pay_price','pay_time','express_price','freight_time','receipt_time','order_status','updatetime','status']);
                // $row->visible(['address']);
