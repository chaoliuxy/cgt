...
class Banner extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign("positionStatusList", $this->model->getPositionStatusList());
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                #10=活动详情,20=课程详情,30=场馆介绍,40=自定义页面
                if ($params['type']=='10') {
                    $params['position_id'] = $params['activity_id'];
                } elseif ($params['type']=='20') {
                    $params['position_id'] = $params['goods_id'];
                } elseif ($params['type']=='30') {
                    if (session('venue_id')) {
                        $params['position_id'] = session('venue_id');
                    } else {
            ...
            if ($params) {
                ...
                if ($params['type']=='10') {
                    ...
                    if (session('venue_id')) {
                        ...
                        $params['position_id'] = $params['venue_id'];
                    }
                }
                $result = false;
                Db::startTrans();
