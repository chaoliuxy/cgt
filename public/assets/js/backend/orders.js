    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'reservation.name', title: __('所属场馆'), operate: 'LIKE'},
                        {field: 'order_no', title: __('Order_no'), operate: 'LIKE'},
                        {field: 'litestoreordergoods.goods_name', title: __('Litestoreordergoods.goods_name'), operate: 'LIKE'},
                        {field: 'litestoreordergoods.goods_attr', title: __('Litestoreordergoods.goods_attr'), operate: 'LIKE'},
                        ...
                        {field: 'order_type', title: __('Order_type'), searchList: {"10":__('Order_type 10'),"20":__('Order_type 20')}, formatter: Table.api.formatter.normal},
                        ...
                        {field: 'pay_status', title: __('Pay_status'), searchList: {"10":__('Pay_status 10'),"20":__('Pay_status 20'),"70":__('Pay_status 70'),"80":__('Pay_status 80'),"90":__('Pay_status 90'),"100":__('Pay_status 100'),"110":__('Pay_status 110')}, formatter: Table.api.formatter.status},
                        ...
                        {field: 'operate', title: __('Operate'), table: table, buttons: [
                            {name: 'send', text: __('view'), icon: 'fa fa-eye', classname: 'btn btn-xs btn-warning btn-dialog chakan', url: 'orders/detail'},
        ...
        detail: function(){
            $("#send").on('click', function() {
                ...
                $("#send-form").attr("action","orders/detail").submit();
            });
            Controller.api.bindevent();
        },
        api: {
