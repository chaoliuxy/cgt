            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'total_price', title: __('Total_price'), operate:'BETWEEN', operate: false},
                        ...
                        {field: 'freight_time', title: __('Freight_time'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime, operate: false},
                        {field: 'receipt_time', title: __('Receipt_time'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime, operate: false},
                        {field: 'status', title: __('Order_status'), searchList:
                        {
                            "10":__('Status 10'),
                            "20":__('Status 20'),
                            "30":__('Status 30'),
