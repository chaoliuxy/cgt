define(['jquery', 'bootstrap', 'backend', 'table', 'form','template','litestoregoods'], function ($, undefined, Backend, Table, Form,Template,litestoregoods) {
  ...
  $("#c-category_id").data("params", function (obj) {
    return {custom: {business_id: $('input[name="row[business_id]"]').val()}};
  });
    var Controller = {
        index: function () {
            $(".btn-add").data("area", ["1000px","800px"]);
						// $(".bth-addshop").chick(
						// 	Fast.api.open('/KIldJsDvMC.php/litestore/litestoregoods/add?type=30','添加商品',{
						// 	})
						// );
						// $(".bth-addcourse").chick(
						// 	Fast.api.open('/KIldJsDvMC.php/litestore/litestoregoods/add?type=10','添加课程',{
						// 	})
						// );
						// $(".bth-addfood").chick(
						// 	Fast.api.open('/KIldJsDvMC.php/litestore/litestoregoods/add?type=20','添加菜品',{
						// 	})
						// );
            // 初始化表格参数配置
            Table.api.init({
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'category_id', visible:false,title: __('Category_id'), operate: false},
                        ...
                        {field: 'sales_initial', title: __('Sales_initial'), operate: false,sortable: true },
                        {field: 'sales_actual', title: __('Sales_actual'), operate: false,sortable: true },
                        {field: 'goods_sort', title: __('Goods_sort'), operate: false},
                        {field: 'delivery_id', title: __('Delivery_id'), operate: false},
